export default function Legacy2023() {
    return (
        <>
            ...
            <h1 className="mb-4 text-7xl w-full text-center text-transparent bg-clip-text bg-gradient-to-t from-transparent to-75% to-text">MAFAVITO</h1>
            ...
            <div id="about">
                ...
                <div className="w-full h-full flex flex-wrap justify-evenly items-center p-4 my-8">
                    ...
                    <div>
                        ...
                        <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/0zpflsYc4PA?si=hM1_z0W7yuawxS-N" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    </div>
                </div>
            </div>
        </>
