...
export default function NavBar() {
    return (
        <nav className="fixed z-50 top-2 left-4 right-4 h-16 bg-white bg-opacity-25 backdrop-blur-md backdrop-brightness-50 rounded-xl noise overflow-hidden backdrop-saturate-[2] p-2 px-4 flex justify-between" style={{ outline: "1px solid rgba(255, 255, 255, 0.5)"}}>
