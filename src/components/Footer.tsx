        ...
        <footer className="p-8 max-md:p-2 pb-2">
            <div className="flex items-start justify-between max-lg:flex-col max-lg:items-center">
                ...
                <div className="w-2/3 max-lg:w-full">
                    <div className="w-full flex justify-evenly max-md:justify-between items-center px-2">
                        <div className="flex flex-col">
                            <h2 className="text-2xl max-md:text-base pb-2">OUR LEGACY</h2>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/legacy/2024">2024</Link>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/legacy/2023">2023</Link>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/legacy/2022">2022</Link>
                        </div>

                        <div className="flex flex-col">
                            <h2 className="text-2xl max-md:text-base pb-2">OUR TEAM</h2>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/">Home</Link>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/team/alumni">Alumni</Link>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/team/sponsors">Sponsors</Link>
                        </div>

                        <div className="flex flex-col">
                            <h2 className="text-2xl max-md:text-base pb-2">ENGINEERING</h2>
                            <Link className="text-lg max-md:text-sm icon m-auto" to="/engineering/bird">BIRD</Link>
